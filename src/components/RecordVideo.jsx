  ...
  return (
    <div className="h-screen w-full flex flex-col bg-white">
      ...
      <div className="flex-1 grid grid-cols-2 gap-4 px-8 transform scale-[0.93] origin-top">
        ...
        <div className="flex flex-col justify-center items-end -mt-5">
          <div className="relative">
            <div className="flex flex-col items-start gap-12 w-[438px] ml-24">
              {/* Glowing Logo */}
              <div className="relative">
                <div className="relative w-20 h-20 ml-5">
        ...
        {/* RIGHT - Video Recording Interface */}
        <div className="flex flex-col items-center mt-4 justify-center relative">
          {/* Video Frame Container */}
          <div className="rounded-[32px] flex items-center justify-center relative overflow-hidden w-[380px] h-[480px] flex-shrink-0 my-5" style={{ backgroundColor: bgColor }}> 
            {/* Background Pattern */}
            ...
            {/* Video Preview with Record Button */}
            <div 
              className="rounded-[32px] w-[200px] h-[410px] relative overflow-hidden z-10 cursor-crosshair"
              onClick={(e) => {
                if (pendingEmoji) {
            ...
            >
              ...
              <video
                ...
                className="w-full h-full object-cover rounded-[32px] shadow-[10px_10px_0px_rgba(0,0,0,0.1)]"
                style={{ display: (stream || isPlayingPreview) ? 'block' : 'none' }}
              />
              {!stream && !isPlayingPreview && (
                <img src="/rv-image-1.jpg" alt="Record Preview" className="absolute inset-0 w-full h-full object-cover rounded-[32px] shadow-[10px_10px_0px_rgba(0,0,0,0.1)]"/>
              )}
              {(isRecording || (stream && showRedButton)) && (
                <div className="absolute top-2 left-1/2 -translate-x-1/2">
                  {/* Timer Container */}
                  <div className="flex h-[28px] px-[13px] py-[8px] justify-between items-center rounded-full bg-[rgba(89,79,68,0.75)] backdrop-blur-[2px] gap-6">
                    {/* Timer */}
                    ...
                    <div className="flex items-center gap-1">
                      {/* HD */}
                      <span className="text-white text-[7.679px] font-medium leading-none">
                        HD
                      </span>
                      {/* Dot Separator */}
      ...
      <div className="flex items-center justify-between px-8 py-3 mt-auto border-t border-gray-100">
        ...
        <div className="flex flex-col items-center">
          <div className="text-[#64748B] text-[18px] font-quicksand">Step 1 of 4</div>
...
const RecordVideo = () => {
  ...
  return isMobile ? <RecordVideoMobile /> : <RecordVideoDesktop />;
};
